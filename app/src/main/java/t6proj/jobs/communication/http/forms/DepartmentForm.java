...
public class DepartmentForm extends AbstractWebForm<Department> {
    public DepartmentForm(Integer id, List<Department> departments)
    {
        ...
        this.elements.put("parentDepartmentId", new Select(departmentOptions).setNullable(true).setLabel("Родительское подразделение"));
